...
"""
Custom File Save Dialog to use across all DCCs to ensure proper file saving location, naming conventions

Reads Environment variables from the shell
Reads a preferences YAML file to load settings defined by a TD/Supervisor
"""
...
OSVFX_LOGO = rename_slash(os.path.join(os.getenv("ICONS_PATH"), "osvfx-dark.png"))
DEFAULT_LOGO = rename_slash(os.path.join(os.getenv("ICONS_PATH"), "no-file-small.jpg"))
